...
public class CursorFixedActivity extends ListActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    public static final String TAG = "CursorFixedActivity";

    private static final int SWIPE_DURATION = 250;
    private static final int MOVE_DURATION = 150;
    private ListView listView;
    private ApplesFilterAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handlerThread = new HandlerThread("db_op");
        handlerThread.start();
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        Log.d(TAG, "onLoadFinished, adapter=" + adapter);
        if (adapter == null) {
            adapter = new ApplesFilterAdapter(this, R.layout.text_with_background, data, touchListener);
